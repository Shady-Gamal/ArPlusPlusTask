...
fun AddToFavorite() {
    ...
    Column(Modifier.fillMaxSize(), horizontalAlignment = Alignment.CenterHorizontally) {
       Spacer(modifier = Modifier.height(100.dp))
        Image(painter = painterResource(id = R.drawable.ic_add), contentDescription = "search",
            modifier = Modifier.size(200.dp), colorFilter = ColorFilter.tint(color = primaryColor))
        Text(text = stringResource(R.string.add_to_favorite), fontWeight = FontWeight.W700, color = textColor)}
